...
import V from "rn-weui/src/variable";
// 导入页面
...
export default class Home extends Component {
    ...
    fetchdaibanData() {
        ...
        // this.setState({visible:true,tip:''}); 由于查询时间过长，暂时注释
        HttpUtil.get(url, this)
            .then((responseData) => {
                this.setState({
            ...
            <View style={{flex: 1, backgroundColor: '#F5F5F5'}}>
                ...
                <TabNavigator tabBarStyle={{backgroundColor: 'white'}}>
                    ...
                    <TabNavigator.Item
                        ...
                        selectedTitleStyle={{color: '#538cff'}}
                        selected={this.state.selectedTab === 'office'}
                        onPress={() => this.setState({selectedTab: 'office'})}
                        renderIcon={() => <Image source={require('../../../img/shouye-nav.png')}
                                                 style={styles.iconStyle}/>}
                        renderSelectedIcon={() => <Image source={require('../../../img/shouye-2.png')}
                                                         style={styles.selectedIconStyle}/>}
                    >
                        <View>
                            <View>
                                <Image source = {require('../../../img/banner1.png')} style={styles.logoImg}/>
                            </View>
                            {
                                Platform.OS === "android" &&
                                <View>
                                    <Image source={require('../../../img/yjbar.png')} style={styles.noticeBar}>
                                        <View style={{justifyContent: 'center', height: 28, backgroundColor: 'rgba(5,49,125,0)'}}>
                                            <Text style={styles.noticeText}>版本 {Service.version}，请卸载旧版本以防兼容问题</Text>
                                        </View>
                                    </Image>
                                </View>
                            }
                            <View style={{width:ViewUtil.screenW-24, marginTop:10, marginBottom: 10, marginLeft:12, flexDirection:'row', justifyContent:'space-between'}}>
                                <Text style={{fontSize: 18, fontWeight: 'bold', color: '#333'}}>功能</Text>
                            </View>
                            <View style={styles.itemContainer}>
                                <TouchableOpacity onPress={this.onPressReportSearch}>
                                    <View style={styles.outViewStyle}>
                                        <Image source={require('../../../img/danjutongji.png')} style={styles.icon_image1}/>
                                        <Text style={styles.icon_text}>单据量统计</Text>
                                    </View>
                                </TouchableOpacity>
                            </View>
                            <View style={{width:ViewUtil.screenW-24, marginTop:10, marginBottom: 10, marginLeft:12, flexDirection:'row', justifyContent:'space-between'}}>
                                <Text style={{fontSize: 18, fontWeight: 'bold', color: '#333'}}>消息</Text>
                            </View>
                            <View style={styles.itemContainer}>
                                <TouchableOpacity onPress={this.onPressDaiban}>
                                    <View style={styles.outViewStyle}>
                                        <Image source={require('../../../img/daibanshixiang.png')} style={styles.icon_image1}/>
                                        {
                                            this.state.daibanMessageNum && this.state.daibanMessageNum !== 0 ?
                                            <Text style={styles.badge}>{this.state.daibanMessageNum}</Text> : null
                                        }
                                        <Text style={styles.icon_text}>待办事项</Text>
                                    </View>
                                </TouchableOpacity>
                                <TouchableOpacity onPress={this.onPressDone}>
                                    <View style={styles.outViewStyle}>
                                        <Image source={require('../../../img/yibanshixiang.png')} style={styles.icon_image1}/>
                    ...
                    <TabNavigator.Item
                        ...
                        renderIcon={() => <Image source={require('../../../img/xietong-nav.png')} style={styles.iconStyle}/>}
                        renderSelectedIcon={() => <Image source={require('../../../img/xietong-2.png')}
                                                         style={styles.selectedIconStyle}/>}
                    >
                        <View>
                            <NavigationBar
                                ...
                                <View style={styles.messageItem}>
                                    <View style={styles.leftListItem}>
                                        <View style={styles.messageItemImage}>
                                            <Image source={require('../../../img/daibanshixiang.png')} style={styles.messageImage}/>
                                        </View>
                            ...
                            <TouchableOpacity onPress={this.onPressDone}>
                                <View style={styles.messageItem}>
                                    <View style={styles.leftListItem}>
                                        <View style={styles.messageItemImage}>
                                            <Image source={require('../../../img/yibanshixiang.png')} style={styles.messageImage}/>
                                        </View>
                                        <View style={styles.messageContent}>
                                            <Text style={styles.message}>已办事项</Text>
                                        </View>
                                    </View>
                                </View>
                            </TouchableOpacity>
                    ...
                    <TabNavigator.Item
                        ...
                        renderIcon={() => <Image source={require('../../../img/my-nav.png')} style={styles.iconStyle}/>}
                        renderSelectedIcon={() => <Image source={require('../../../img/my-2.png')}
                                                         style={styles.selectedIconStyle}/>}
                    >
                        <View>
                            ...
                            <TouchableOpacity onPress={this.onPressUserMsg}>
                                <View style={styles.topViewStyle}>
                                    ...
                                    <Image source={{uri: 'rarrow'}} style={{width: 8, height: 13, marginRight: 8}}/>
                                </View>
                            </TouchableOpacity>
...
const styles = StyleSheet.create({
    ...
    noticeText: {
        fontSize: 12, width: ViewUtil.screenW - 100, color: '#fff', marginLeft: ViewUtil.screenW * 0.24,
    }
});
